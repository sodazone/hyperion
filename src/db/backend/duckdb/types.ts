...
export type DefiVolumeSeriesRow = {
	ts: string;
	protocol: string;
	market_id: string;
...
export type DefiVolumeRow = {
	...
	current_swap_volume_usd: number;
	previous_swap_volume_usd: number;

	current_borrow_volume_usd: number;
	previous_borrow_volume_usd: number;
